...
add(id="f01", mec="vitrine", selo="VITRINE", conceito="objetivo1",
    enunciado="Olhe cada <b>sólido de vidro</b> brilhar. Toque para ouvir o nome dele.",
    dica="Toque numa peça de vidro: eu falo o nome e para que serve.",
...
add(id="f02", mec="escolher", selo="ESCOLHA", conceito="objetivo1",
    ...
    dados=[
      {"img":"", "p":"Qual objeto tem a forma de uma <b>esfera</b> (bola)?",
       "c":"BOLA", "e":["DADO","LATA","CAIXA"],
      ...
      {"p":"Qual objeto tem a forma de um <b>cubo</b>?",
       "c":"DADO", "e":["BOLA","CASQUINHA DE SORVETE","LATA"],
      ...
      {"p":"Qual objeto tem a forma de um <b>cilindro</b>?",
       "c":"LATA", "e":["DADO","CASQUINHA DE SORVETE","CAIXA DE SAPATO"],
...
add(id="f03", mec="ligar", selo="LIGUE", conceito="objetivo1",
    enunciado="Ligue cada <b>sólido</b> ao objeto que tem a forma dele.",
    dica="Pense: onde eu já vi essa forma no meu dia?",
    dados=[{"k":"p0","t":"ESFERA","s":"Bola"},
           {"k":"p1","t":"CUBO","s":"Dado"},
           {"k":"p2","t":"CILINDRO","s":"Lata"},
           {"k":"p3","t":"CONE","s":"Casquinha de sorvete"}],
    dadosExtra={"DICAS":[
...
add(id="f04", mec="memoria", selo="MEMÓRIA", conceito="objetivo1",
    ...
    dica="Vire duas cartas. Se a forma combinar, é par!",
    dados=[
      {"k":"cubo","pal":"CUBO","fig":"sg_cubo_v","sen":"dado","figsen":"sg_dado"},
      {"k":"esf","pal":"ESFERA","fig":"sg_esfera_v","sen":"bola","figsen":"sg_bola"},
      {"k":"cil","pal":"CILINDRO","fig":"sg_cilindro_v","sen":"lata","figsen":"sg_lata"},
      {"k":"cone","pal":"CONE","fig":"sg_cone_v","sen":"sorvete","figsen":"sg_sorvete"}])
...
add(id="f07", mec="ligar", selo="LIGUE", conceito="objetivo2",
    ...
    dados=[{"k":"p0","t":"ESFERA","s":"Rola pela rampa"},
           {"k":"p1","t":"CUBO","s":"Fica firme, parado"},
           {"k":"p2","t":"CILINDRO","s":"Rola deitado"},
           {"k":"p3","t":"PIRÂMIDE","s":"Fica firme, parada"}],
    dadosExtra={"DICAS":[
...
add(id="f10", mec="arrastar-sombra", selo="CADA UM, SUA SOMBRA", conceito="objetivo2",
    ...
    dadosExtra={"FORMAS":{
      "quad":{"n":"QUADRADO (cubo)","voz":"o quadrado","cor":"#5aa0e0",
              "cp":"polygon(8% 8%,92% 8%,92% 92%,8% 92%)"},
      "circ":{"n":"CÍRCULO (bola)","voz":"o círculo","cor":"#e0824a",
              "cp":"circle(46% at 50% 50%)"},
      "tri":{"n":"TRIÂNGULO (pirâmide)","voz":"o triângulo","cor":"#e2c24a",
             "cp":"polygon(50% 6%,94% 94%,6% 94%)"},
      "ret":{"n":"RETÂNGULO (bloco)","voz":"o retângulo","cor":"#7cc05a",
             "cp":"polygon(6% 26%,94% 26%,94% 74%,6% 74%)"}},
      "DICAS":[
...
add(id="f11", mec="intruso", selo="QUAL NÃO É?", conceito="objetivo2",
    ...
    dados=[
      {"selo":"OS QUE ROLAM","tipo":"texto",
       ...
       "d3":"O de fora é o CUBO: ele fica firme, os outros rolam.",
       ...
       "p3":"Esfera, cilindro e cone rolam. O cubo fica firme — por isso é o de fora.",
      ...
      {"selo":"OS QUE FICAM FIRMES","tipo":"texto",
       ...
       "d3":"A de fora é a ESFERA: ela rola, os outros ficam firmes.",
       ...
       "p3":"Cubo, bloco e pirâmide ficam firmes. A esfera rola — por isso é a de fora.",
...
add(id="f12", mec="vitrine", selo="VITRINE", conceito="objetivo2",
    enunciado="Toque em cada sólido de vidro e ouça: ele <b>rola</b> ou <b>fica firme</b>?",
...
add(id="f13", mec="ligar", selo="LIGUE", conceito="objetivo3",
    enunciado="Ligue a <b>face</b> (o lado plano) ao sólido dela.",
    dica="Olhe o lado do sólido: que figura plana aparece ali?",
    dados=[{"k":"p0","t":"QUADRADO","s":"É a face do cubo"},
           {"k":"p1","t":"RETÂNGULO","s":"É a face do bloco"},
           {"k":"p2","t":"TRIÂNGULO","s":"É a face da pirâmide"},
           {"k":"p3","t":"CÍRCULO","s":"É a base do cilindro"}],
    dadosExtra={"DICAS":[
...
add(id="f20", mec="escolher", selo="ESCOLHA", conceito="objetivo1",
    enunciado="Vamos revisar! Escolha a resposta certa.",
    dica="Pense com calma: forma, rolar e objeto.",
    dados=[
      {"img":"","p":"Qual sólido é <b>todo redondo</b> e rola para todo lado?",
       "c":"ESFERA","e":["CUBO","PIRÂMIDE","BLOCO"],
       "d":["Sem cantos, sem lados retos.","É a forma da bola.","É a ESFERA. Toque para seguir."]},
      {"img":"","p":"O <b>chapéu de festa</b> tem a forma de qual sólido?",
       "c":"CONE","e":["CILINDRO","CUBO","ESFERA"],
       "d":["Tem ponta em cima.","É a mesma forma da casquinha de sorvete.","É o CONE. Toque para seguir."]},
      {"img":"","p":"Qual sólido tem <b>6 faces quadradas iguais</b>?",
       "c":"CUBO","e":["BLOCO RETANGULAR","PIRÂMIDE","CILINDRO"],
       "d":["Todos os lados iguais.","É a forma do dado.","É o CUBO. Toque para seguir."]},
    ], dadosExtra={"TITULO":"REVISÃO","FECHO":"Você lembra de tudo!"})
...
add(id="f21", mec="ligar", selo="LIGUE", conceito="objetivo3",
    ...
    dados=[{"k":"p0","t":"Casquinha de sorvete","s":"CONE"},
           {"k":"p1","t":"Caixa de sapato","s":"BLOCO RETANGULAR"},
           {"k":"p2","t":"Bola","s":"ESFERA"},
           {"k":"p3","t":"Lata","s":"CILINDRO"}],
    dadosExtra={"DICAS":[
...
add(id="f23", mec="intruso", selo="QUAL NÃO É?", conceito="objetivo3",
    ...
    dados=[
      {"selo":"OS REDONDOS","tipo":"texto",
       ...
       "d3":"O de fora é o DADO: é cubo e fica firme.",
       ...
       "p3":"Bola, laranja e lata rolam. O dado (cubo) fica firme — por isso é o de fora.",
...
add(id="f25", mec="memoria", selo="MEMÓRIA", conceito="objetivo3",
    enunciado="Ache a <b>palavra</b> e o <b>desenho que combina</b>.",
    dica="Vire duas cartas e veja se a forma combina.",
    dados=[
      {"k":"pir","pal":"PIRÂMIDE","fig":"sg_piramide_v","sen":"telhado","figsen":"sg_telhado"},
      {"k":"bloco","pal":"BLOCO","fig":"sg_bloco_v","sen":"caixa","figsen":"sg_sapato"},
      {"k":"cone","pal":"CONE","fig":"sg_cone_v","sen":"chapéu","figsen":"sg_chapeu"},
      {"k":"cil","pal":"CILINDRO","fig":"sg_cilindro_v","sen":"copo","figsen":"sg_copo"}])
...
add(id="f26", mec="arrastar-sombra", selo="CADA UM, SUA SOMBRA", conceito="objetivo2",
    ...
    dadosExtra={"FORMAS":{
      "quad":{"n":"QUADRADO","voz":"o quadrado","cor":"#5aa0e0","cp":"polygon(8% 8%,92% 8%,92% 92%,8% 92%)"},
      "circ":{"n":"CÍRCULO","voz":"o círculo","cor":"#e0824a","cp":"circle(46% at 50% 50%)"},
      "tri":{"n":"TRIÂNGULO","voz":"o triângulo","cor":"#e2c24a","cp":"polygon(50% 6%,94% 94%,6% 94%)"},
      "ret":{"n":"RETÂNGULO","voz":"o retângulo","cor":"#7cc05a","cp":"polygon(6% 26%,94% 26%,94% 74%,6% 74%)"}},
      "DICAS":[
        "Compare o <b>contorno</b>: a sombra tem o mesmo formato.",
...
add(id="f31", mec="ligar", selo="LIGUE", conceito="objetivo3",
    ...
    dica="Pense na forma de cada objeto.",
    dados=[{"k":"p0","t":"Telhado","s":"PIRÂMIDE"},
           {"k":"p1","t":"Presente","s":"CUBO"},
           {"k":"p2","t":"Copo","s":"CILINDRO"},
           {"k":"p3","t":"Tijolo","s":"BLOCO RETANGULAR"}],
    dadosExtra={"DICAS":[
      "Pense na forma de cada objeto.",
